                            ...
                            <div class="row">
                                <div class="card-body border-bottom bg-light">
                                    ...
                                    <table class="table table-borderless table-sm mb-4">
                                        <tr>
                                            <th class="text-muted" style="width: 160px;">Username</th>
                                            <td><%= currentOrder.getUsername()%></td>
                                        </tr>
                                        <tr>
                                            <th class="text-muted">Shipping Address</th>
                                            <td><%= currentOrder.getOrderAddress() != null ? currentOrder.getOrderAddress() : "Not provided"%></td>
                                        </tr>
                                    </table>

                                    <h4 class="fw-bold mb-3">Order Info</h4>
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="bg-light fw-bold">
                                                    ...
                                                    <td class="text-end pe-4 text-success"><%= formatter.format(currentOrder.getTotalAmount())%> VND</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
