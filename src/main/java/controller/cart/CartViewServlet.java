...
import dao.CartDAO;
import dao.BookDAO;
import dao.VoucherDAO; // ✅ Đổi từ PromotionDAO
import dto.CartDTO;
import dto.BookDTO;
import dto.VoucherDTO; // ✅ Đổi từ PromotionDTO
...
public class CartViewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DBContext.getConnection()) {
            ...
            // Lấy voucher còn hạn
            List<VoucherDTO> vouchers = voucherDAO.getValidVouchers(); // ✅ Đổi tên hàm
            request.setAttribute("vouchers", vouchers); // ✅ Nếu dùng tên mới trong JSP
